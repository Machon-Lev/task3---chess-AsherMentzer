...
Rook::Rook(char cColor):Piece(cColor){}

Rook::~Rook(){}

char Rook::GetPiece(){return "R";}

bool Rook::AreSquaresLegal(int iSrcRow, int iSrcCol, int iDestRow, int iDestCol, Piece* GameBoard[8][8]){
    if (iSrcRow == iDestRow) {
